...
Once a month, our PTO has a meeting at the school. During this meeting, parents, teachers and administrators discuss the Parent Plan and the calendar of events for the coming months. This is when parents get involved with developing, reviewing and implementing the plan. Members will be added to the committee at this time. The PTO president is present at the open house and at Cat Camp to recruit parent representation. A message is pushed out encouraging parents to join PTO.
...
- ***2.1:** How does the School distribute an informational packet appropriate for the age and grade*

*of each child annually, ensuring to include:*

- *description of the engagement program*
- *recommended roles for parents, students, teacher, and the School*
- *ways for a family to get involved*
- *survey regarding volunteer interests*
- *schedule of activities planned throughout the school year*
- *regular, two-way, and meaningful system for parents/teachers to communicate* [*A.C.A. § 6-15-1702(b)(3)(B)(i)*]
...
- *How is relevant information provided in a variety of ways? (For example, paper copies* *made available, as well as social media posts, website links, parent apps, etc.?* [*ESSA § 1116(e)(5)*]
- ***2.3:** How does the School offer flexible opportunities for meetings with families?*
[*ESSA § 1116(c)(2)*]

**Simon Middle School will distribute information to parents using the Simon Middle School website,** **The Conway Public School APP and the Simon Middle School Facebook page that is developed with** **participation of the teachers. It includes school news, a calendar of school activities, parenting tips** **related to school achievement and will showcase class activities. All of these sources of** **communication are offered in Spanish also. Parents will be able to access their child's grades using** **Eschool and Schoology. Parents will also be contacted through the CPS APP and Remind APP by** **teachers to inform them of other school related activities. Parents may use email to communicate** **with members of the school staff. Teachers will routinely contact parents on an individual basis to** **communicate about their child's progress. Paper copies of school events and activities may also be** **sent home. The student/parent handbook is shared at the beginning of each year. Parents are** **offered multiple avenues for communicating and meeting with teachers: face to face, Google Meet and phone conference.**

## <u>3: Building Staff Capacity</u>

Describe activities that will be used with School staff to build their capacity to work with parents as equal partners.

*Guiding Questions*

- ***3.1:** How does the School build staff capacity to work with parents as equal partners? This may* *include workshops, conferences, trainings, webinars, and online resources that will be used to* *ensure ALL School staff (including teachers, specialized instructional personnel, principals, and*

*other School leaders) are aware of:*
...
- *how to implement and coordinate parent programs and build ties between home and* *the School* [*Title I schools*]
...
- *the School’s process for resolving parent concerns as outlined in the School handbook,* *including how to define a problem, whom to approach first, and how to develop* *solutions* [*all schools*] [*ESSA § 1116(e)(3;14); A.C.A. § 6-15-1702(b)(5-7); A.C.A. § 6-15-1702(b)(3)(B(ii)*]
Each year, prior to the start of the new school year, teachers and staff are provided professional development regarding parental involvement and how we can best involve our parents during our parent and family engagement activities. Monthly faculty meetings are held and other professional development may be provided on various means of communicating with parents.

## <u>4: Building Parent Capacity</u>
...
- *the forms of State and Local academic assessments used to measure student progress,* *including alternate assessments*
- *the achievement levels of the challenging State academic standards students are* *expected to meet* [*ESSA § 1116(c)(4)(B)*]
- ***4.2:** How does the School provide assistance to parents in understanding the following:*
- *the requirements of Title I, Part A*
- *how to monitor their child’s progress*
- *how to work with educators to improve the achievement of their children.* [*ESSA § 1116(e)(1)*]

*What types of materials and training does the School provide to help parents work with* *their children to improve their children’s achievement? This may include:*

- ***4.3:*** *○* *○* *○* *○*
- ***4.4:*** *limitation:* *○* *○* *○* *○* *○* *○* *○*
- ***4.5:*** *○* *○*
- ***4.6:*** *limitation:* *○* *○* *○*
*literacy training* *technology training, including education about copyright piracy and safe practices* *resources that describe or assist with the child’s curriculum* *other activities such as workshops, conferences, online resources like tutorials or* *webinars, and any equipment or other materials, including parent resource centers* [*ESSA § 1116(e)(2)*]

*involvement in the education of their children* *volunteer activities* *learning activities and support classroom instruction* *participation in School decisions* *collaboration with the community* *development of School goals and priorities* *evaluating the effectiveness of the School-level Improvement Plan* [*A.C.A. § 6-15-1702(b)(1); ADE Rules Governing Parental Involvement Section 3.03*]

*purchase parenting books, magazines, and other informative material regarding* *responsible parenting through the School library, advertise the current selection, and* *give parents an opportunity to borrow the materials for review* *create parent centers* [*A.C.A. § 6-15-1702(b)(4)(A)*]

*role play and demonstration by trained volunteers* *the use of and access to Division of Elementary and Secondary Education website tools* *for parents [*<u>https://dese.ade.arkansas.gov/</u>*]* *assistance with nutritional meal planning* [*A.C.A. § 6-15-1702(b)(5)(B)(ii)(a-d)*]

*Involve parents of students at all grade levels in a variety of roles, including without*

*How does the School promote and support responsible parenting? The School shall, as* *funds are available:*

*How does the School provide instruction to parents on how to incorporate* *developmentally appropriate learning activities in the home environment, including without*

Parents may check out materials, use the computer and smartphones using the CPS APP to check grades and visit educational websites. The school will distribute (digitally and/or paper copies) informational packets each year that include a copy of the school's parental involvement plan, a survey to request volunteers and information about the system that will be used to allow parents and teachers to communicate (notes, phone calls, email). Parents are provided information on how to support their students at the Open House, Cat Camp and Family Night. Parents are also encouraged to volunteer and join PTO at these events. Instructions on accessing grades are sent out to parents. Interim and quarterly report cards are sent home. IEP meetings are held to address alternate assessments and achievement

levels. Assessment data (STAR and ACT Aspire) are sent regularly to parents. In an effort to promote and support responsible parenting, the school will provide parenting books and other informative materials regarding parenting through the school library and allow parents the opportunity to borrow the materials for review.
...
- *organizations/activities to help students transition to elementary, middle, high, and* *postsecondary schools or careers*
- *wraparound services that allow families to send their children to school ready and able* *to focus on learning* [*ESSA §1116(e)(4)*]
...
The school coordinates with other organizations, businesses and community partners to provide additional supports and resources to families: Community Connections, Kroger, Harps, Local churches and Soul Food Cafe Mission. The school coordinates with other programs such as Pinnacle Pointe Behavioral Healthcare, Counseling Associates and Arkansas Children's Hospital Educational Audiology/Speech Pathology Resources for Schools (EARS) to provide resources and additional support to families. Once a month the PTO group meets to discuss upcoming events.

<u>6: Annual Title I Meeting</u> *(Title I schools)*
...
- *the parents’ rights under Title I (The Right to Know Teacher Qualifications, Right to* *Request Meetings)* [*ESSA § 1116(c)(1)*]
## <u>7: School-Parent Compact</u> (Title I schools)
...
- *Outlines how parents, the entire School staff, and students will share the responsibility* *for improved student academic achievement*
- *Addresses the importance of regular two-way, meaningful communication through:* *■ conferences (no fewer than 2 each year)* *■ frequent reports on progress* *■ reasonable access to staff* *■ opportunities to volunteer* *■ observation of classroom activities* [*ESSA § 1116(d)*]
...
- *Include a link or insert the language of the compact to demonstrate this requirement* *has been met.* [*ESSA § 1116(d)(2)(A)*]

<u>8: Reservation of Funds</u> *(Title I schools)*
...
- *Who is involved in determining that?* [*ESSA § 1116(a)(3)(A)*]
...
|A.2:|The School understands that the following must be made available to families and the local community on the School or District website no later than August 1st: o the School Engagement Plan o a parent-friendly explanation of the School and District’s Engagement Plan o the informational packet o contact information for the parent facilitator designated by the School.|
...
**A.15:** The School understands its obligation, if requested by parents, to provide opportunities for regular meetings to formulate suggestions and to participate, as appropriate, in decisions relating to the education of their children, and respond to any such suggestions as soon as practicably possible. [*ESSA § 1116(c)(4)(C)*]
## School Information

|School Name:|Raymond and Phyllis Simon Middle School||
|---|---|---|
|School Engagement Facilitator Name:|Brandi Nixon||
|Plan Revision/Submission Date:|August 1, 2024||
|District Level Reviewer Name, Title:|Benjamin Darley-Director of Federal Programs||
|||8|

|District Level Approval Date:|||June 12, 2024|
|---|---|---|---|
|||Committee Members, Role (Select "Repeat" to open more entry fields to add additional team members)||
|First Name|Last Name||Role (Teacher, Staff, Parent, Student, or Community Member)|
|Brandi|Nixon||Staff|
|Demetre|Calhoun||Staff|
|Angel|Moix||Teacher|
|Melissa|Gates||Parent|

## <u>District Reviewer Responses</u>
